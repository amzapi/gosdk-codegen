...
const (
	ContainerIdentificationContainerIdentificationTypeAMZNCC ContainerIdentificationContainerIdentificationType = "AMZNCC"

	ContainerIdentificationContainerIdentificationTypeBPS ContainerIdentificationContainerIdentificationType = "BPS"

	ContainerIdentificationContainerIdentificationTypeCID ContainerIdentificationContainerIdentificationType = "CID"

	ContainerIdentificationContainerIdentificationTypeGTIN ContainerIdentificationContainerIdentificationType = "GTIN"

	ContainerIdentificationContainerIdentificationTypeSSCC ContainerIdentificationContainerIdentificationType = "SSCC"
)

// Defines values for DimensionsUnitOfMeasure.
const (
	DimensionsUnitOfMeasureFt DimensionsUnitOfMeasure = "Ft"

	DimensionsUnitOfMeasureIn DimensionsUnitOfMeasure = "In"

	DimensionsUnitOfMeasureMeter DimensionsUnitOfMeasure = "Meter"

	DimensionsUnitOfMeasureYard DimensionsUnitOfMeasure = "Yard"
)

// Defines values for DurationDurationUnit.
const (
	DurationDurationUnitDays DurationDurationUnit = "Days"

	DurationDurationUnitMonths DurationDurationUnit = "Months"
)
...
const (
	ShipmentConfirmationShipmentConfirmationTypeOriginal ShipmentConfirmationShipmentConfirmationType = "Original"

	ShipmentConfirmationShipmentConfirmationTypeReplace ShipmentConfirmationShipmentConfirmationType = "Replace"
)

// Defines values for ShipmentConfirmationShipmentStructure.
const (
	ShipmentConfirmationShipmentStructureLooseAssortmentCase ShipmentConfirmationShipmentStructure = "LooseAssortmentCase"

	ShipmentConfirmationShipmentStructureLooseStandardCase ShipmentConfirmationShipmentStructure = "LooseStandardCase"

	ShipmentConfirmationShipmentStructureMasterCase ShipmentConfirmationShipmentStructure = "MasterCase"

	ShipmentConfirmationShipmentStructureMasterPallet ShipmentConfirmationShipmentStructure = "MasterPallet"

	ShipmentConfirmationShipmentStructurePalletOfItems ShipmentConfirmationShipmentStructure = "PalletOfItems"

	ShipmentConfirmationShipmentStructurePalletizedAssortmentCase ShipmentConfirmationShipmentStructure = "PalletizedAssortmentCase"

	ShipmentConfirmationShipmentStructurePalletizedStandardCase ShipmentConfirmationShipmentStructure = "PalletizedStandardCase"
)
...
const (
	StopFunctionCodeFreightPayableAt StopFunctionCode = "FreightPayableAt"

	StopFunctionCodePortOfDischarge StopFunctionCode = "PortOfDischarge"

	StopFunctionCodePortOfLoading StopFunctionCode = "PortOfLoading"
)
...
const (
	VolumeUnitOfMeasureCuFt VolumeUnitOfMeasure = "CuFt"

	VolumeUnitOfMeasureCuIn VolumeUnitOfMeasure = "CuIn"

	VolumeUnitOfMeasureCuM VolumeUnitOfMeasure = "CuM"

	VolumeUnitOfMeasureCuY VolumeUnitOfMeasure = "CuY"
)

// Defines values for WeightUnitOfMeasure.
const (
	WeightUnitOfMeasureG WeightUnitOfMeasure = "G"

	WeightUnitOfMeasureKg WeightUnitOfMeasure = "Kg"

	WeightUnitOfMeasureLb WeightUnitOfMeasure = "Lb"

	WeightUnitOfMeasureOz WeightUnitOfMeasure = "Oz"
)
