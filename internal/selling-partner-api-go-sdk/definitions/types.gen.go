...
const (
	SchemaLinkLinkVerbGET SchemaLinkLinkVerb = "GET"
)
...
type GetDefinitionsProductTypeParams struct {
	...
	Requirements *GetDefinitionsProductTypeParamsRequirements `json:"requirements,omitempty"`
	...
	RequirementsEnforced *GetDefinitionsProductTypeParamsRequirementsEnforced `json:"requirementsEnforced,omitempty"`
	...
	Locale *GetDefinitionsProductTypeParamsLocale `json:"locale,omitempty"`
}
