// Package vendorPayments provides primitives to interact with the openapi HTTP API.
//
...
const (
	AdditionalDetailsTypeCartonCount AdditionalDetailsType = "CartonCount"
...
const (
	AllowanceDetailsTypeDefective AllowanceDetailsType = "Defective"

	AllowanceDetailsTypeDiscount AllowanceDetailsType = "Discount"

	AllowanceDetailsTypeDiscountIncentive AllowanceDetailsType = "DiscountIncentive"

	AllowanceDetailsTypePromotional AllowanceDetailsType = "Promotional"

	AllowanceDetailsTypeSpecial AllowanceDetailsType = "Special"

	AllowanceDetailsTypeUnsaleableMerchandise AllowanceDetailsType = "UnsaleableMerchandise"
)

// Defines values for ChargeDetailsType.
const (
	ChargeDetailsTypeCollectionAndRecyclingService ChargeDetailsType = "CollectionAndRecyclingService"

	ChargeDetailsTypeDuty ChargeDetailsType = "Duty"

	ChargeDetailsTypeEnvironmentalProtectionService ChargeDetailsType = "EnvironmentalProtectionService"

	ChargeDetailsTypeFreight ChargeDetailsType = "Freight"

	ChargeDetailsTypeInsuranceFee ChargeDetailsType = "InsuranceFee"

	ChargeDetailsTypeInsurancePlacementCost ChargeDetailsType = "InsurancePlacementCost"

	ChargeDetailsTypePacking ChargeDetailsType = "Packing"

	ChargeDetailsTypeService ChargeDetailsType = "Service"

	ChargeDetailsTypeSmallOrder ChargeDetailsType = "SmallOrder"

	ChargeDetailsTypeSpecialHandlingService ChargeDetailsType = "SpecialHandlingService"

	ChargeDetailsTypeTaxCollectedAtSource ChargeDetailsType = "TaxCollectedAtSource"
)
...
const (
	PaymentTermsTypeBasic PaymentTermsType = "Basic"

	PaymentTermsTypeEndOfMonth PaymentTermsType = "EndOfMonth"

	PaymentTermsTypeFixedDate PaymentTermsType = "FixedDate"

	PaymentTermsTypeLetterofCredit PaymentTermsType = "LetterofCredit"

	PaymentTermsTypePaymentDueUponReceiptOfInvoice PaymentTermsType = "PaymentDueUponReceiptOfInvoice"

	PaymentTermsTypeProximo PaymentTermsType = "Proximo"
)
