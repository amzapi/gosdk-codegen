...
type GetOrderMetricsParams struct {
	...
	Granularity GetOrderMetricsParamsGranularity `json:"granularity"`
	...
	BuyerType *GetOrderMetricsParamsBuyerType `json:"buyerType,omitempty"`
	...
	FirstDayOfWeek *GetOrderMetricsParamsFirstDayOfWeek `json:"firstDayOfWeek,omitempty"`
