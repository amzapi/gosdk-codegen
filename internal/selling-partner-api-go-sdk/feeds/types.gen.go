...
const (
	FeedDocumentCompressionAlgorithmGZIP FeedDocumentCompressionAlgorithm = "GZIP"
)

// Defines values for FeedDocumentEncryptionDetailsStandard.
const (
	FeedDocumentEncryptionDetailsStandardAES FeedDocumentEncryptionDetailsStandard = "AES"
)
...
type FeedDocumentEncryptionDetails struct {
	...
	Standard FeedDocumentEncryptionDetailsStandard `json:"standard"`
}

// The encryption standard required to encrypt or decrypt the document contents.
type FeedDocumentEncryptionDetailsStandard string
...
type GetFeedsParams struct {
	...
	ProcessingStatuses *[]GetFeedsParamsProcessingStatuses `json:"processingStatuses,omitempty"`
