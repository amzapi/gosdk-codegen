...
type ClientWithResponsesInterface interface {
	// GetInventorySummaries request
	GetInventorySummariesWithResponse(ctx context.Context, params *GetInventorySummariesParams, reqEditors ...RequestEditorFn) (*GetInventorySummariesResponse, error)
}
...
func (r GetInventorySummariesResponse) Status() string {
...
func (r GetInventorySummariesResponse) StatusCode() int {
	if r.HTTPResponse != nil {
...
func (c *ClientWithResponses) GetInventorySummariesWithResponse(ctx context.Context, params *GetInventorySummariesParams, reqEditors ...RequestEditorFn) (*GetInventorySummariesResponse, error) {
	rsp, err := c.GetInventorySummaries(ctx, params, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetInventorySummariesResponse(rsp)
}

// ParseGetInventorySummariesResponse parses an HTTP response from a GetInventorySummariesWithResponse call
func ParseGetInventorySummariesResponse(rsp *http.Response) (*GetInventorySummariesResponse, error) {
